import { contextRestoreLayerIds, contextSnapshotLayerIds, mergeContextTransitionErrors, settleContextIntentReplay } from '../contextModePolicy.js';
 ...
 */
export async function _restoreContextSessionAfterLayerSettles(layerId, { notificationToken = null } = {}) {
