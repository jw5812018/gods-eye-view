import { contextAllowedLayerIds, mergeContextTransitionErrors } from '../contextModePolicy.js';

export async function _selectContextMode(mode, { notificationToken = null, signal = null } = {}) {
    ...
    const isCurrent = () => !this.destroyed && generation === this._contextModeGeneration;
...
export async function _deactivateContextForLayerChange({ notificationToken = null } = {}) {
